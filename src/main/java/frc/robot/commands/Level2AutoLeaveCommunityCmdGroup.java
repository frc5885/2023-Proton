...
public class Level2AutoLeaveCommunityCmdGroup extends SequentialCommandGroup {

    public Level2AutoLeaveCommunityCmdGroup(GripperSubsystem gripperSubsystem, ArmSubsystem armSubsystem, DrivingSubsystem drivingSubsystem){
        addCommands(new MoveArmToLevelCommand(armSubsystem, Constants.levelTwoTarget),
