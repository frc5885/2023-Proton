...
public class Level3AutoLeaveCommunityCommand extends CommandBase {
    ...
    public Level3AutoLeaveCommunityCommand(FlapSubsystem flapSubsystem, ArmSubsystem armSubsystem, GripperSubsystem gripperSubsystem, DrivingSubsystem drivingSubsystem) {
