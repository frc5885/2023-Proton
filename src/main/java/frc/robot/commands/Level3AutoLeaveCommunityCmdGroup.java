...
public class Level3AutoLeaveCommunityCmdGroup extends SequentialCommandGroup {

    public Level3AutoLeaveCommunityCmdGroup(GripperSubsystem gripperSubsystem, ArmSubsystem armSubsystem, DrivingSubsystem drivingSubsystem){
